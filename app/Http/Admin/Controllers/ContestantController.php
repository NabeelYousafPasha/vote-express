...
class ContestantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $table = [
            ...
            'action' => [
                'route_name_edit' => 'admin.contestant.edit',
                'route_name_delete' => '',
                'route_name_show' => 'admin.contestant.show',
        ...
        if ($request->contest_id) {
            ...
            return view('admin.contestants.show', compact('dataa','title','titles','table'));
        }
        $contest = Contest::paginate(10);
        
        return view('admin.contestants.index', compact('contest','title','titles','table'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($contest) {
           return view('admin.contestants.create',compact('title','titles','contest'));
        }
    }
    ...
    public function getVotePercentage(Request $request)
    {
        dd($request);
    }
    ...
    public function edit(Request $request,$id)
    {
        ...
        if ($request->queryy=='form_data') 
        {
            $form_data=json_decode($contestant->contestt->form_data,false);
            $contestant_data=$contestant->form_data;

            return view('admin.contestants.edit',compact('title','titles','contestant','form_data','contestant_data'));
        }
        else {
            return view('admin.contestants.edit',compact('title','titles','contestant'));
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with("status", "contestant deleted.");
    }
}
