                        ...
                        <div class="col-md-6 text-right pr-4">
                            @foreach ($contest->topfivecontestants as $contestant)
                                @if(isset($contestant->avatar))
                                    <img class="avatar avatar-sm rounded-circle mt-4" style="border: 5px solid #efe3e3;border: 5px solid #efe3e3;" src="{{asset('storage/'.$contestant->avatar)}}" width="13%" alt="">
                                @else
                                    <img class="avatar avatar-sm rounded-circle mt-4" style="border: 5px solid #efe3e3;border: 5px solid #efe3e3;" src="{{asset('storage/uploads/contestants/default-contestant.png')}}" width="13%" alt="">
                                @endif
                                ...
                                <div class="col-md-3 mb-5 @if (count($contest->contestants) == 3) mx-auto @endif">
                                    <div class="box" style="padding-top: 0;padding-bottom: 5px;overflow: hidden;">
                                        ...
                                        <div class="row abs-avatar">
                                            @if(isset($contestant->avatar))
                                                <img class="avatar avatar-sm rounded-circle mx-auto" style="border: 5px solid #efe3e3;border: 5px solid #efe3e3;" src="{{asset('storage/'.$contestant->avatar)}}" width="50%" alt="">
                                            @else
                                                <img class="avatar avatar-sm rounded-circle mx-auto" style="border: 5px solid #efe3e3;border: 5px solid #efe3e3;" src="{{asset('storage/uploads/contestants/default-contestant.png')}}" width="50%" alt="">
                                            @endif
