        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ return_if(on_page('account.brand.index'), ' active') }}" href="{{ route('account.brand.index') }}" >
                            <i class="fas fa-calendar"></i>
                            <span class="nav-link-text">Brand Management</span>
                        </a>
                        {{-- <div class="collapse" id="navbar-brands">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('account.brand.index') }}">
                                        All Brands
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('account.brand.create') }}">
                                        Submit a Brand
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-contests">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('account.contest.index') }}">
                                        All Contests
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('account.contest.create') }}">
                                        Add a Contest
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-contestants">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('account.contestants.index') }}">
                                        All Contestants
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link{{ return_if(on_page('account.reports.index'), ' active') }}" href="{{route('account.reports.index')}}">
                ...
                <hr class="my-3">
                <!-- Heading -->
                <h6 class="navbar-heading p-0 text-muted text-center">Vote-Express Demo V1.0</h6>
