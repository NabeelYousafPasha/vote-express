                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="media align-items-center">
                                <span class="avatar avatar-sm rounded-circle">
                                    <img alt="Image placeholder" src="{{ asset('storage/'.Auth::user()->profile_image)}}">
                                </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ route('admin.dashboard') }}">
                                <i class="ni ni-circle-08" style="margin-right: 3px"></i>
                            ...
                            <!-- User Account Link route('account.index')  -->
                            <a class="dropdown-item" href="#">
                                <i class="ni ni-single-02" style="margin-right: 3px"></i>
                            ...
                            <i class="fas fa-sign-out-alt"  style="margin-right: 3px"></i>
                                Logout
                            </a>
