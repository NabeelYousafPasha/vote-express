@section('sidebar')
    ...
    <li class="nav-item nav-dropdown">
        <a class="nav-link nav-dropdown-toggle" href="#">
            <i class="icon-lock"></i>Manage Contest
        </a>
        <ul class="nav-dropdown-items">
            <li class="nav-item">
                <a class="nav-link{{ return_if(on_page('admin.contest.create'), ' active') }}"
                   href="{{ route('admin.contest.create') }}">
                    <i class="icon-plus"></i> Add Contest
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ return_if(on_page('admin.contest.index'), ' active') }}"
                   href="{{ route('admin.contest.index') }}">
                    <i class="icon-lock"></i>All Contests
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="nav-item nav-dropdown">
        ...
        <ul class="nav-dropdown-items">
            ...
            <li class="nav-item">
                <a class="nav-link{{ return_if(on_page('admin.users.index'), ' active') }}"
                   href="{{ route('admin.users.index') }}">
                    <i class="icon-people"></i>A to Z
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ return_if(on_page('admin.users.index'), ' active') }}"
                   href="{{ route('admin.users.index') }}">
                    <i class="icon-people"></i>Z to A
                </a>
            </li>
        </ul>
    </li>
    ...
    <!-- payments -->
    <li class="nav-item">
        <a class="nav-link{{ return_if(on_page('admin.reports.index'), ' active') }}" href="{{ route('admin.reports.index') }}">
