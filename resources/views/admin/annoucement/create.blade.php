    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.annoucement.store') }}" method="POST" class="form-horizontal offset-sm-2">
                ...
                <div class="form-group row {{ $errors->has('receiver') ? ' has-error' : '' }}">
                ...
                <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-dot-circle-o"></i> Send Message</button>
            </form>
