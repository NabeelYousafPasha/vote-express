...
@section('content')
            ...
            <div class="container">
                <div class="content">
                    <div class="row d-flex align-items-center">
                        <div class="col-md-6">
                            <div class="left">
                                <h3>Best Voting and Engagement Platform</h3>
        ...
        <section class="our-price" id="price">
            <div class="container text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 @if ($loop->iteration == 4) mx-auto @endif">
                        ...
                        @endif
                            ...
                            <h4>$<span>{{ $plan->price }}</span>/ {{str_replace(","," ",$plan->duration) }}</h4>
                            <ul>
                                <li>Brand(s): {{$plan->brand}}</li>
                                <li>Contest(s): {{$plan->contest}}</li>
                                <li style="padding-left: 2.5rem;padding-right: 2.5rem">{{$plan->other_info_1 ?? ''}}
                                    <br>
                                    <small><em>{{$plan->other_info_2 ?? ''}}</em></small>
                                </li>
                            </ul>
                            {{-- <a href="{{ route('home') }}/subscription?plan={{ $plan->slug }}" class="btn-2">Get Started</a> --}}
                            <a href="#" class="btn-2">Coming Soon</a>
        ...
        <!-- ======== Start Contact Us ======== -->
        <section class="contact" style="padding-top: 1px;" id="contact">
            <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="info d-flex align-items-start">
                                ...
                                <h4 class="d-inline-block">EMAIL :
                                    <br>
                                    <span>votexpress@gmail.com</span></h4>
                            </div>
                            <!-- Info-3 -->
                            <div class="info d-flex align-items-start">
