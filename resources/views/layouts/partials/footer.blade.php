<!-- ======== Start Footer ======== -->
<footer class="footer" style="padding: 15px 0px">
    <div class="container text-center">
        <img src="{{ asset('img/vote.png') }}" width="100" alt="">
        <p>© {{ date('Y') }} Votexpress. All rights reserved.</p>
    </div>
</footer>
<!-- ======== End Footer ======== -->

<div class="modal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-full mx-auto" style="min-width: 56%" role="document">
            <div class="modal-content">
                <div class="modal-header" style="padding-bottom: 0">
                        <a class="navbar-brand" style="padding-bottom:0px; padding-top:0px" href="{{ route('home') }}"><img src="{{ asset('img/vote.png') }}" width="100" alt="logo"></a>
                ...
                <div class="modal-body" id="result">
                        <div class="container register" style="background: none !important">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 register-right">
                                        <ul class="nav nav-tabs nav-justified mx-auto" style="float: none" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Login</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" style="margin-left: 15px;" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Register</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                ...
                                                <div class="row register-form">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="submit" class="btnRegister" style="border-radius: 0.3rem;"  value="Create account"/>
                                                    </div>
                                                </div>
                                                </form>
                                            </div>
